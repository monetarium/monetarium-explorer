...
- **Precision**: VAR uses 8 decimals, SKA uses 18 decimals. Formatting helpers live in the explorer (`float64AsDecimalParts`, `FormatSKAPerVAR`, `FormatSKAAtoms`). Don't print raw atoms.
