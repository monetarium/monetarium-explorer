...
8. Renaming the template or the dataSource method → update the `tmpls` slice at [explorer.go:384-388](../../../cmd/dcrdata/internal/explorer/explorer.go#L384-L388) and the [explorer_test.go:82](../../../cmd/dcrdata/internal/explorer/explorer_test.go#L82) mock.
