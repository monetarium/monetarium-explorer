...
**Current state — live (PR #395).** [cmd/dcrdata/main.go:784-785](../../../cmd/dcrdata/main.go#L784-L785)
...
link ([extras.tmpl:93](../../../cmd/dcrdata/views/extras.tmpl#L93)); a follow-up commit
...
- **Data structures:** Postgres tables `agendas` + `agenda_votes`
  ...
  ([gov/agendas/deployments.go:33](../../../gov/agendas/deployments.go#L33)); `dbtypes.AgendaSummary`
  ([types.go:978](../../../db/dbtypes/types.go#L978)); `dbtypes.AgendaVoteChoices`
  ([types.go:2126](../../../db/dbtypes/types.go#L2126)) with parallel arrays
...
- **Transformations / writes:**
  ...
  - **Reads:** `AgendaVotes(ctx, id, chartType)`
    ([pgblockchain.go:1621](../../../db/dcrpg/pgblockchain.go#L1621)) → `retrieveAgendaVoteChoices`;
...
- **HTML — `AgendasPage`** ([explorerroutes.go:2201-2253](../../../cmd/dcrdata/internal/explorer/explorerroutes.go#L2201-L2253)):
  ...
  **The page renders agendas twice from two sources, so the handler cross-filters the cards to the
  ...
  [func at 2200-2208](../../../cmd/dcrdata/internal/explorer/explorerroutes.go#L2259-L2267), PR #401),
...
- **HTML — `AgendaPage`** ([explorerroutes.go:2106-2198](../../../cmd/dcrdata/internal/explorer/explorerroutes.go#L2106-L2198)):
...
- **JSON — `getAgendasData`** ([apiroutes.go:2173-2203](../../../cmd/dcrdata/internal/api/apiroutes.go#L2173-L2203)):
...
- **JSON — `getAgendaData`** ([apiroutes.go:2132-2168](../../../cmd/dcrdata/internal/api/apiroutes.go#L2132-L2168)):
...
Both page containers are now `<main>` landmarks rather than `<div class="container main">`
(accessible-names pass); `data-controller="agendas"` and the agenda page's
`data-controller="agenda" data-agenda-id` contracts are unchanged.
...
- **`views/agendas.tmpl`** — `data-controller="agendas"`; renders `VoteSummary.Agendas`,
  ...
  ([templates.go:775](../../../cmd/dcrdata/internal/explorer/templates.go#L775)),
...
- **Nav coupling.** The navbar ([extras.tmpl:93](../../../cmd/dcrdata/views/extras.tmpl#L93)) has
...
- **PRE-VOTING meters gate on non-empty `VoteSummary.Agendas` (commit `07f2d444`).** Inside the
  ...
  PRE-VOTING section at [agendas.tmpl:106-141](../../../cmd/dcrdata/views/agendas.tmpl#L106-L141) is:
  ```
...
1. **Restored the two routes** at [main.go:784-785](../../../cmd/dcrdata/main.go#L784-L785):
...
2. **Re-added the navbar link** at
   [extras.tmpl:93](../../../cmd/dcrdata/views/extras.tmpl#L93) ("Agendas" `menu-item` →
...
- **PRE-VOTING meters rendered for v10 on mainnet with no Monetarium agendas.** Removing the
  ...
  [agendas.tmpl:106-141](../../../cmd/dcrdata/views/agendas.tmpl#L106-L141) — reverting to
...
- `AllAgendas()` DB error → `ExpStatusError` page. **Note:** the *all-filtered* case (no agenda
  ...
  ([agendas.tmpl:232](../../../cmd/dcrdata/views/agendas.tmpl#L232)) at HTTP 200. Letting
...
- Live routes / re-enable: [main.go:784-785](../../../cmd/dcrdata/main.go#L784-L785)
...
- Handlers: `AgendasPage`
  [explorerroutes.go:2201-2253](../../../cmd/dcrdata/internal/explorer/explorerroutes.go#L2201-L2253),
  `AgendaPage` [explorerroutes.go:2106-2198](../../../cmd/dcrdata/internal/explorer/explorerroutes.go#L2106-L2198);
  nil-summary guard
  [explorerroutes.go:2127-2131](../../../cmd/dcrdata/internal/explorer/explorerroutes.go#L2127-L2131)
...
- Vote-version filter (issue #400): constant `MinVoteVersion`
  ...
  [agendas.tmpl:232](../../../cmd/dcrdata/views/agendas.tmpl#L232).
- Summary-card cross-filter (PR #401): allowed-ID set
  [explorerroutes.go:2154-2156](../../../cmd/dcrdata/internal/explorer/explorerroutes.go#L2154-L2156),
  ...
  [func 2200-2208](../../../cmd/dcrdata/internal/explorer/explorerroutes.go#L2259-L2267); test
  `TestFilterAgendaSummaries` [agendapage_test.go:78](../../../cmd/dcrdata/internal/explorer/agendapage_test.go#L78);
  cards rendered at [agendas.tmpl:26-221](../../../cmd/dcrdata/views/agendas.tmpl#L26-L221);
...
- PRE-VOTING meters guard (commit `07f2d444`): condition at
  [agendas.tmpl:106-141](../../../cmd/dcrdata/views/agendas.tmpl#L106-L141) —
...
- API: [apirouter.go:211-218](../../../cmd/dcrdata/internal/api/apirouter.go#L211-L218),
  [apiroutes.go:2132-2203](../../../cmd/dcrdata/internal/api/apiroutes.go#L2132-L2203);
...
- Node support: `monetarium-node/chaincfg@v1.3.10` `mainnetparams.go:148`/`testnetparams.go:147`
  ...
  `GetVoteInfoResult`).
- Navbar ("Agendas" link, re-added in PR #395): [extras.tmpl:93](../../../cmd/dcrdata/views/extras.tmpl#L93).
